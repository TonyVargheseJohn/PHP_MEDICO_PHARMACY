            ...
            <div class="row">
             ...
             $selCat = "SELECT * from tbl_category";
                    ...
                    <ul class="list-group" id="subcat">
                     ...
                     <tr>
   <th scope="col"><a href="MyCart.php">Go to Cart</a></th>
  </tr>
                </div>
                <div class="col-lg-9">
                    ...
                    <div class="text-center">
                        <img src="../Asset/Template/Search/loader.gif" id='loder' width="200" style="display: none"/>
                    </div>
...
function changeSub()
            {
                ...
                {
                    $.ajax({
                        url: "../Asset/AjaxPages/AjaxSearchSubCat.php?data=" + cat,
            ...
            function productCheck(){
                    ...
                    $.ajax({
                        url: "../Asset/AjaxPages/AjaxSearchProduct.php?action=" + action +"&category=" + category+"&subcategory=" + subcategory+"&name=" + name,
                        success: function(response) {
