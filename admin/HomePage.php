...
<head>
    ...
    <!-- Favicon icon -->
    <link rel="icon" href="../Asset/Template/Admin/assets/images/favicon.ico" type="image/x-icon">
    <!-- Google font-->
    <link href="https://fonts.googleapis.com/css?family=Open+Sans:400,600,700" rel="stylesheet">
    <!-- waves.css -->
    <link rel="stylesheet" href="../Asset/Template/Admin/assets/pages/waves/css/waves.min.css" type="text/css" media="all">
    <!-- Required Fremwork -->
    <link rel="stylesheet" type="text/css" href="../Asset/Template/Admin/assets/css/bootstrap/css/bootstrap.min.css">
    <!-- waves.css -->
    <link rel="stylesheet" href="../Asset/Template/Admin/assets/pages/waves/css/waves.min.css" type="text/css" media="all">
    <!-- themify icon -->
    <link rel="stylesheet" type="text/css" href="../Asset/Template/Admin/assets/icon/themify-icons/themify-icons.css">
    <!-- font-awesome-n -->
    <link rel="stylesheet" type="text/css" href="../Asset/Template/Admin/assets/css/font-awesome-n.min.css">
    <link rel="stylesheet" type="text/css" href="../Asset/Template/Admin/assets/css/font-awesome.min.css">
    <!-- scrollbar.css -->
    <link rel="stylesheet" type="text/css" href="../Asset/Template/Admin/assets/css/jquery.mCustomScrollbar.css">
    <!-- Style.css -->
            ...
            <nav class="navbar header-navbar pcoded-header">
                <div class="navbar-wrapper">
                    <div class="navbar-logo">
                        ...
                        <a href="index.html">
                            <img class="img-fluid" src="../Asset/Template/Admin/assets/images/logo.png" alt="Theme-Logo" />
                        </a>
                            ...
                            <li class="header-notification">
                                ...
                                <ul class="show-notification">
                                    ...
                                    <li class="waves-effect waves-light">
                                        <div class="media">
                                            <img class="d-flex align-self-center img-radius" src="../Asset/Template/Admin/assets/images/avatar-2.jpg" alt="Generic placeholder image">
                        ...
                        <div class="pcoded-inner-navbar main-menu">
                            <div class="">
                                <div class="main-menu-header">
                                    <img class="img-80 img-radius" src="../Asset/Template/Admin/assets/images/avatar-4.jpg" alt="User-Profile-Image">
                                ...
                                <div class="main-menu-content">
                                    <ul>
                                        <li class="more-details">
                                            <a href="My Profile.php"><i class="ti-user"></i>View Profile</a>
                                            <!-- <a href="#!"><i class="ti-settings"></i>Settings</a> -->
                                            <a href="../guest/Login.php"><i class="ti-layout-sidebar-left"></i>Logout</a>
                                        </li>
                                    </ul>
                                </div>
                            </div>
                            ...
                            <div class="pcoded-navigation-label">Userlist</div>
                            <ul class="pcoded-item pcoded-left-item">
                                <li class="">
                                    <a href="Userlist.php" class="waves-effect waves-dark">
                                        <span class="pcoded-micon"><i class="ti-layers"></i><b>FC</b></span>
                                        <span class="pcoded-mtext">Userlist</span>
                                        <span class="pcoded-mcaret"></span>
                                    </a>
                                </li>
                            </ul>
                            ...
                            <ul class="pcoded-item pcoded-left-item">
                                <li class="">
                                    <a href="ViewFeedback.php" class="waves-effect waves-dark">
                                        <span class="pcoded-micon"><b>C</b></span>
                            ...
                            <div class="pcoded-navigation-label">User Complaints</div>
                            <ul class="pcoded-item pcoded-left-item">
                                <li class="">
                                    <a href="ViewUserComplaints.php" class="waves-effect waves-dark">
                                        <span class="pcoded-micon"><b>C</b></span>
                           ...
                           <div class="pcoded-navigation-label">User Bookings</div>
                            <ul class="pcoded-item pcoded-left-item">
                                <li class="">
                                    <a href="UserBooking.php" class="waves-effect waves-dark">
                                        <span class="pcoded-micon"><b>C</b></span>
                            ...
                            <div class="pcoded-navigation-label">Activities</div>
                            <ul class="pcoded-item pcoded-left-item">
                                <li class="">
                                  ...
                                  <li class="">
                                    <a href="subCategory.php" class="waves-effect waves-dark">
                                        <span class="pcoded-micon"><b>C</b></span>
                            ...
                            <ul class="pcoded-item pcoded-left-item">
                                <li class="">
                                    <a href="Report1.php" class="waves-effect waves-dark">
                                        <span class="pcoded-micon"><b>C</b></span>
                                        <span class="pcoded-mtext">Get Report 1</span>
                                        <span class="pcoded-mcaret"></span>
                                    </a>
                                </li>
                                <li class="">
                                    <a href="Report 2.php" class="waves-effect waves-dark">
                                        <span class="pcoded-micon"><b>C</b></span>
                                        <span class="pcoded-mtext">Get Report 2</span>
                                        <span class="pcoded-mcaret"></span>
                                    </a>
                                </li>
                                    <li class="">
                                    <a href="Report3.php" class="waves-effect waves-dark">
                                        <span class="pcoded-micon"><b>C</b></span>
                                        <span class="pcoded-mtext">Get Report 3</span>
                                        <span class="pcoded-mcaret"></span>
                                    </a>
                                </li>
                                
                               
                                <div class="pcoded-navigation-label">Medicine Request</div>
                                <ul class="pcoded-item pcoded-left-item">
                                    <li class="">
                           ...
                           <!-- <div class="pcoded-navigation-label">Admin Activities</div>
                            <ul class="pcoded-item pcoded-left-item">
                                <li class="pcoded-hasmenu ">
                                    <a href="" class="waves-effect waves-dark">
                                        <span class="pcoded-micon"><i class="ti-id-badge"></i><b>A</b></span>
                                        <span class="pcoded-mtext">Show More</span>
                                        <span class="pcoded-mcaret"></span>
                                    </a>
                                    <ul class="pcoded-submenu">
                                        <li class="">
                                            <a href="Company.php" class="waves-effect waves-dark">
                                                <span class="pcoded-micon"><i class="ti-angle-right"></i></span>
                                                <span class="pcoded-mtext">Add New Company</span>
                                                <span class="pcoded-mcaret"></span>
                                            </a>
                                        </li>
                                        <li class="">
                                ...
                                <div class="row align-items-center">
                                    <div class="col-md-8">
                                        <div class="page-header-title">
                                            ...
                                            <p class="m-b-0">Welcome to Medico Pharma</p>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <ul class="breadcrumb">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-xl-4 col-md-12">
                                                <div class="card mat-stat-card">
                                                    ...
                                                    <div> 
                                                    <img src="../Asset/Template/Admin/paraimg.jpg">
                                                            ...
                                                            <table class="table table-hover m-b-0 without-header">
                                                                <tbody> -->
                                                                    <!-- <tr>
                                                                        <td>
                                                                            <div class="d-inline-block align-middle">
                                                                                <img src="../Asset/Template/Admin/assets/images/avatar-4.jpg" alt="user image" class="img-radius img-40 align-top m-r-15">
                                                                    ...
                                                                    <!-- <tr>
                                                                        <td>
                                                                            <div class="d-inline-block align-middle">
                                                                                <img src="../Asset/Template/Admin/assets/images/avatar-2.jpg" alt="user image" class="img-radius img-40 align-top m-r-15">
                                                                                <div class="d-inline-block">
        ...
        <ul class="iew-download">
            <li>
                <a href="http://www.google.com/chrome/">
                    <img src="../Asset/Template/Admin/assets/images/browser/chrome.png" alt="Chrome">
                    <div>Chrome</div>
                </a>
            </li>
            <li>
                <a href="https://www.mozilla.org/en-US/firefox/new/">
                    <img src="../Asset/Template/Admin/assets/images/browser/firefox.png" alt="Firefox">
                    <div>Firefox</div>
                </a>
            </li>
            <li>
                <a href="http://www.opera.com">
                    <img src="../Asset/Template/Admin/assets/images/browser/opera.png" alt="Opera">
                    <div>Opera</div>
                </a>
            </li>
            <li>
                <a href="https://www.apple.com/safari/">
                    <img src="../Asset/Template/Admin/assets/images/browser/safari.png" alt="Safari">
                    <div>Safari</div>
                </a>
            </li>
            <li>
                <a href="http://windows.microsoft.com/en-us/internet-explorer/download-ie">
                    <img src="../Asset/Template/Admin/assets/images/browser/ie.png" alt="">
                    <div>IE (9 & above)</div>
                </a>
            </li>
        </ul>
...
<![endif]-->
    ...
    <!-- waves js -->
    <script src="../Asset/Template/Admin/assets/pages/waves/js/waves.min.js"></script>
    ...
    <script src="../Asset/Template/Admin/assets/js/vertical/vertical-layout.min.js "></script>
