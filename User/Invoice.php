...
$d=date('Y-m-d');
	...
	session_start();
		...
		$sel="select * from tbl_booking b inner join tbl_user u on u.user_id=b.user_id inner join tbl_cart c on c.booking_id=b.booking_id inner join tbl_product p on p.prod_id=c.prod_id where b.booking_id='".$_GET["Bid"]."'";
